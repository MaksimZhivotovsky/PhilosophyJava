...
import max.chapter_11.Exercise_13.Event;

public class Exercise_13 {

	public Exercise_13() {
		
		GreenHoExt gc = new GreenHoExt();
		// Вместо жесткой фиксации параметров в коде
		// можно было бы считать информацию
		// из текстового файла:

		List<Event> eventList = Arrays.asList(gc.new Bell(900), gc.new ThermostatNight(0),
				gc.new LightOn(200), gc.new LightOff(400), gc. new HumidificationOn(34),
				gc.new HumidificationOff(56), gc.new WaterOn(600), gc.new WaterOff(800),
				gc.new GreenhouseOn(300), gc.new GreenhouseOff(400), gc.new ThermostatDay(1400));
	...
	public class GreenHoExt extends GreenhouseControls {
